...
class AdminCalender_ADDNEW_Perf extends Component{
  constructor(props){
    super(props);
  ...
  render(){
    ...
    return(
      ...
      <div className="add_new_blog">
        <div className="anb_headerText">Add New Calender Event (Performances)</div>
...
export default connect(mapStateToProps)(AdminCalender_ADDNEW_Perf);
